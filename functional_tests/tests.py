...
class NewVisitorTest(StaticLiveServerTestCase ):
    ...
    def wait_for_row_in_list_table(self, row_text, message=None):
    ...
    def test_can_start_a_list_and_retrieve_later(self):
        ...
        self.assertIn('Tarefas', self.browser.title)
        header_text = self.browser.find_element_by_tag_name('h1').text
        self.assertIn('Tarefas', header_text)
        ...
        inputbox.send_keys('Comprar penas de pavões')

        # When she hits enter, the page updates, and now the page lists
        # "1: Buy peacock feathers" as an item in a to-do list
        inputbox.send_keys(Keys.ENTER)

        self.wait_for_row_in_list_table('1: Comprar penas de pavões')

        # There is still a text box inviting her to add another item. She
        # enters "Use peacock feathers to make a fly" (Edith is very methodical)
        inputbox = self.browser.find_element_by_id('id_new_item')
        inputbox.send_keys('Usar penas de pavão para levantar vôo')
        inputbox.send_keys(Keys.ENTER)
        ...
        self.wait_for_row_in_list_table(
            '2: Usar penas de pavão para levantar vôo')
    ...
    def test_multiple_users_can_start_lists_at_different_urls(self):
        ...
        self.assertNotIn('levantar vôo', page_text)
